    ...
    div()
        ...
        .child(
            div()
                ...
                .child(app_icon(IconName::Download, 12.0, foreground)),
        )
        .child(
            div()
                .absolute()
...
impl Waku {
    ...
    fn render_updater_button(&self, cx: &mut Context<Self>) -> Option<AnyElement> {
        ...
        if !available {
            let indicator = motion::spin_slow(app_icon(IconName::LoaderCircle, 14.0, foreground));
            return Some(
                button
                    ...
                    div()
                        ...
                        .children(agent_preset_label.map(|label| {
                            div()
                                ...
                                .font_weight(FontWeight::MEDIUM)
                                .text_color(theme.text_secondary)
                                .child(app_icon(IconName::Bot, 10.5, theme.text_tertiary))
    ...
    pub(super) fn render_empty_state(&self, cx: &mut Context<Self>) -> Div {
        ...
        if self.selected_project().is_none() {
            return div()
                ...
                .px_8()
                .pb(px(46.0))
                .child(app_icon(IconName::Sparkle, 24.0, theme.accent))
                .child(
                    div()
                        .mt(px(16.0))
                        .text_size(px(20.0))
        ...
        div()
            ...
            .px_8()
            .pb(px(52.0))
            .child(app_icon(IconName::Sparkle, 20.0, theme.accent))
            .child(
                div()
                    .mt(px(14.0))
                    .flex()
