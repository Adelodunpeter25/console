...
fn named_color_to_terminal(
    named: alacritty_terminal::vte::ansi::NamedColor,
) -> Option<TerminalColor> {
    use alacritty_terminal::vte::ansi::NamedColor;
    match named {
        NamedColor::Black => Some(TerminalColor {
            r: 0x1a,
            g: 0x1a,
            b: 0x1e,
        }),
        NamedColor::Red => Some(TerminalColor {
            r: 0xef,
            g: 0x44,
            b: 0x44,
        }),
        NamedColor::Green => Some(TerminalColor {
            r: 0x22,
            g: 0xc5,
            b: 0x5e,
        }),
        NamedColor::Yellow => Some(TerminalColor {
            r: 0xea,
            g: 0xb3,
            b: 0x08,
        }),
        NamedColor::Blue => Some(TerminalColor {
            r: 0x3b,
            g: 0x82,
            b: 0xf6,
        }),
        NamedColor::Magenta => Some(TerminalColor {
            r: 0xa8,
            g: 0x55,
            b: 0xf7,
        }),
        NamedColor::Cyan => Some(TerminalColor {
            r: 0x06,
            g: 0xb6,
            b: 0xd4,
        }),
        NamedColor::White => Some(TerminalColor {
            r: 0xe4,
            g: 0xe4,
            b: 0xe7,
        }),
        NamedColor::BrightBlack => Some(TerminalColor {
            r: 0x52,
            g: 0x52,
            b: 0x5b,
        }),
        NamedColor::BrightRed => Some(TerminalColor {
            r: 0xf8,
            g: 0x71,
            b: 0x71,
        }),
        NamedColor::BrightGreen => Some(TerminalColor {
            r: 0x4a,
            g: 0xde,
            b: 0x80,
        }),
        NamedColor::BrightYellow => Some(TerminalColor {
            r: 0xfa,
            g: 0xcc,
            b: 0x15,
        }),
        NamedColor::BrightBlue => Some(TerminalColor {
            r: 0x60,
            g: 0xa5,
            b: 0xfa,
        }),
        NamedColor::BrightMagenta => Some(TerminalColor {
            r: 0xc0,
            g: 0x84,
            b: 0xfc,
        }),
        NamedColor::BrightCyan => Some(TerminalColor {
            r: 0x22,
            g: 0xd3,
            b: 0xee,
        }),
        NamedColor::BrightWhite => Some(TerminalColor {
            r: 0xf4,
            g: 0xf4,
            b: 0xf5,
        }),
