...
final class ProjectSetupModel: ObservableObject {
    ...
    @Published var clonedProjects: [Project] = []
...
struct ProjectSetupSelectionView: View {
    ...
    private func folderChoiceRow(_ choice: ProjectSetupModel.FolderChoice) -> some View {
        ...
        .animation(.spring(response: 0.15, dampingFraction: 0.82), value: isSelected)
    }
...
struct ProjectSetupPanel: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            .animation(.spring(response: 0.2, dampingFraction: 0.82), value: model.selectedFolders.count)
        }
        .frame(maxWidth: 560)
