...
/**
 * High-performance, zero-builder protobuf wire codecs (vendored from
 * oh-my-pi's catalog package — adapted to inline its only external dep,
 * `isRecord` from @oh-my-pi/pi-utils).
 *
