        ...
        {call.name === "subagent" ? (
          <Pressable
            ...
            onPress={(e) => {
              ...
              const subagentId = typeof args?.subagentId === "string" ? args.subagentId : null;
              if (subagentId) {
            ...
            className="px-2 py-0.5 rounded bg-white/[0.08] active:bg-white/[0.15]"
          >
            <Text className="text-[10.5px] font-medium text-[#38bdf8]">
              View →
            </Text>
          </Pressable>
        ) : null}
